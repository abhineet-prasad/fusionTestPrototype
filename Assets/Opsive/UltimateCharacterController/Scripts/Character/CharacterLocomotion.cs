...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    public class CharacterLocomotion : StateBehavior, IForceObject
    {
        ...
        [SerializeField] protected float m_VerticalCastBuffer = 2;
            ...
            if (slide) {
                ...
                for (int i = 0; i < m_ColliderCount; ++i) {
                    ...
                    if (ResolvePenetrations(m_Colliders[i], m_DesiredMovement, out var offset)) {
                        m_DesiredMovement = m_DesiredMovement.normalized * Mathf.Min(m_DesiredMovement.magnitude, offset.magnitude);
                    }
                }
